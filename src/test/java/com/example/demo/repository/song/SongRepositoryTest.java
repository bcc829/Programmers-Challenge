...
public class SongRepositoryTest {
    ...
    @Test
    public void findBySongsTitleLikeAndLocalesInLocaleJpTest(){
        List<Song> songEntities = songRepository.getSongsByLikeSongTitleAndLocalesIn("my album", "jp");
        assertEquals(2, songEntities.size());
    }

    @Test
    public void findBySongsTitleLikeAndLocalesInLocaleKrTest(){
        List<Song> songEntities = songRepository.getSongsByLikeSongTitleAndLocalesIn("my album", "kr");
        assertEquals(3, songEntities.size());
    }
