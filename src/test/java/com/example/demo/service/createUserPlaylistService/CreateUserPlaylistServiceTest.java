...
public class CreateUserPlaylistServiceTest {
    ...
    @Test
    public void createUserPlaylistTest() {
        UserPlaylistDto userPlaylistDto = new UserPlaylistDto();
        userPlaylistDto.setUserId(3L);
        userPlaylistDto.setTitle("user 3's playlist");

        userPlaylistDto = createUserPlaylistService.createUserPlaylist(userPlaylistDto);

        assertNotNull(userPlaylistDto.getId());
    }
