...
public class DeleteUserPlaylistServiceTest {
    ...
    public void DeleteUserPlaylistTest() {
        ...
        assertTrue(deleteUserPlaylistService.deleteUserPlaylistById(userPlaylist.getId()));
    }

    @Test
    public void DeleteUserPlaylistWithNoElementTest() {
        assertTrue(deleteUserPlaylistService.deleteUserPlaylistById(99999));
    }
